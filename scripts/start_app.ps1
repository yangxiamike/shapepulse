...
try { Invoke-WebRequest -Uri "http://127.0.0.1:3000/" -UseBasicParsing -TimeoutSec 2 | Out-Null } catch {
...
for ($attempt = 0; $attempt -lt 60; $attempt++) {
    try {
        ...
        Write-Host "Local market workbench is ready: http://127.0.0.1:3000/"
        exit 0
